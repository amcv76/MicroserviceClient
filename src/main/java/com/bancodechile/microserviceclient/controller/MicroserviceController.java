package com.bancodechile.microserviceclient.controller;
...
import com.bancodechile.microserviceclient.services.IService;
...
public class MicroserviceController {
    ...
    @PostMapping
    public ResponseEntity<String> insert(@RequestBody Clients cl){
        try{
    ...
    @GetMapping("/id")
    public ResponseEntity<Clients> findById(@RequestParam("id") long id){
       try{
    ...
    @PutMapping
    public ResponseEntity<String> update(@RequestBody Clients cl){
        try{
